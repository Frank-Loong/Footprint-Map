...
### [1.2.2] - 2025-06-29
**修复**
- 修复模板字符串首字符非 `<` 导致 jQuery `Syntax error, unrecognized expression` 报错，地图视图切换按钮和图片查看模态框无法渲染的问题。

**改进**
- 统一使用 `FOOTPRINT_MAP_VERSION` 常量作为脚本/样式版本号，避免浏览器缓存旧文件。
- 插件主文件、后台"关于作者"信息同步更新版本号。
